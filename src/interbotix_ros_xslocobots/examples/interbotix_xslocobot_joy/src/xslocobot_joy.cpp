...
static const double MAX_BASE_X = 0.1;         // Max translational motion that the base can do is 0.7 m/s
// static const double MAX_BASE_THETA = 3.14;    // Max rotational motion that the base can do is 3.14 rad/s
static const double MAX_BASE_THETA = 3.14/6.0;    // Max rotational motion that the base can do is 3.14 rad/s
